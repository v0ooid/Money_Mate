            ...
            if (!appLockUnlock) {
                ...
                navController.addOnDestinationChangedListener { _, destination, _ ->
                    ...
                    if (destination.id == R.id.monetaryAccountFragment
                        ...
                        || destination.id == R.id.appLock6DigitFragment || destination.id == R.id.appLockCustomPasswordFragment ) {
...
//        val sharedPreferences = getSharedPreferences("APP_LOCK_PREFS", Context.MODE_PRIVATE)
//
//        val appLockStatus = sharedPreferences.getBoolean("APP_LOCK_ENABLED_KEY", true)
//        val appLockType = sharedPreferences.getString("SECURITY_TYPE_KEY", "")
//        val appLockPIN = sharedPreferences.getString("PIN_KEY", "")
//
//        // Check if the app lock is enabled
//        if (appLockStatus) {
//            // Check if the app lock has been unlocked
//            val isAppLockUnlocked = sharedPreferences.getBoolean("APP_LOCK_UNLOCKED", false)
//
//            if (!isAppLockUnlocked) {
//                // The app lock is enabled but hasn't been unlocked yet
//                if (appLockType != null && appLockType.isNotEmpty() && appLockPIN != null && appLockPIN.isNotEmpty()) {
//                    if (appLockType == "4Digit") {
//                        val intent = Intent(this, AppLockActivity::class.java)
//                        startActivity(intent)
//                    }
//                    // Add handling for other types of locks if needed
//                } else {
//                    // App lock is enabled but some information is missing
//                    val errorMessage = "App lock configuration is incomplete."
//                    showToast(errorMessage)
//                }
//            } else {
//                // The app lock has been unlocked, proceed with regular flow
//                // For example, show the main screen or perform other necessary actions
//                showMainScreen()
//            }
//        }
//    }
